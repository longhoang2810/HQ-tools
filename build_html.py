...
function runLines(text, resultsEl, mode) {
  ...
  let table = `<div class="card">
    ...
    ${sttNote}
    ${stats}
    <div class="table-wrap"><table><thead><tr><th>STT</th><th>Mô tả</th><th>${matchHead}</th><th>Kết luận</th></tr></thead><tbody>`;
  per.forEach((p, i) => {
    ...
    if (!matches.length) {
      ...
      // lam ca dong vang/do. Pill phang, khong dropdown: ket luan da nam ngay tren pill.
