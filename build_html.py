...
<div class="card instructions">
  ...
  <div>
    ...
    <ol>
      ...
      <li>Nếu doanh nghiệp không khai mã CAS nào, công cụ tự dò <b>tên hóa chất</b> có trong đoạn (tiếng Việt hoặc tiếng Anh, không cần gõ dấu); gõ một phần tên cũng ra danh sách chất có tên đó. Chỉ dò tên khi đoạn không có mã CAS — mô tả đã có mã CAS thì chỉ tra theo mã.</li>
...
<div class="card" id="input-card">
  ...
  <div class="toolbar">
    ...
    <button class="mini" onclick="randomNameExample()">🔤 Ví dụ không có mã CAS</button>
...
function run() {
  ...
  if (entries.length === 0) {
    ...
    // Tra theo ten KHONG co case "Khong ro" nhu nhanh CAS: ten khong khop thi
